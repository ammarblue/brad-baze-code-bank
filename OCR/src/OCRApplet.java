...
/**
 * Java Neural Network Example Handwriting Recognition Copyright 2005 by Heaton
 * Research, Inc. by Jeff Heaton (http://www.heatonresearch.com) 10-2005
 * ------------------------------------------------- This source code is
 * copyrighted. You may reuse this code in your own compiled projects. However,
 * if you would like to redistribute this source code in any form, you must
 * obtain permission from Heaton Research. (support@heatonresearch.com).
 * -------------------------------------------------
 * 
 * This class implements an applet that allows the user to test out basic
 * character recognition functions.
 * 
 * ------------------------------------------------- Want to learn more about
 * Neural Network Programming in Java? Have a look at our e-book:
 * 
...
public class OCRApplet extends Applet {
	...
	public void init() {
		...
		topButtonPanel.add(recognize = new Button("Recognize"),
				BorderLayout.SOUTH);
		...
		topPanel.add(message = new Label(
				"Draw a capital letter, click Recognize"), BorderLayout.NORTH);
