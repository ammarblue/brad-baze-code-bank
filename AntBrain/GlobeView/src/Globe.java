...
public class Globe extends PApplet{
	...
	PImage txtMap;
	int globeRadius;
	float rWRatio, rHRatio, ROTATION_FACTOR = .01f * DEG_TO_RAD;
	PVector rotation, rotSpeed;

	// Textured sphere implementation
	float[][] texturedSphereX, texturedSphereY, texturedSphereZ,
			texturedSphereU, texturedSphereV;
	...
	void setTexturedSphereDetail(int detail) { // Set the detail level for
												// textured spheres,
												// constructing the underlying
												// vertex and uv map data
