...
class Photo {
	...
	Photo(terrainmarch terrainmarch, String n, int scene, PVector sd, PVector _cpos, float _cangX,
			float _cangY, int noiseS, boolean post, boolean uc) {
	...
	public void Output() {
		...
		output.println("new PVector(" + this.terrainmarch.g_sunDir.x + "," + this.terrainmarch.g_sunDir.y + ","
				+ this.terrainmarch.g_sunDir.z + "),");
		output.print("new PVector(" + this.terrainmarch.g_camControl.m_camPos.x + ","
				+ this.terrainmarch.g_camControl.m_camPos.y + "," + this.terrainmarch.g_camControl.m_camPos.z
				+ "),");
		output.print(this.terrainmarch.g_camControl.m_CamAngleX + ","
				+ this.terrainmarch.g_camControl.m_CamAngleY + "," + this.terrainmarch.g_NoiseSeed + ",");
		output.print(this.terrainmarch.g_usePost + "," + this.terrainmarch.g_useClouds + "),");
		output.flush();
		output.close();
	}
	...
	public void Set() {
		...
		this.terrainmarch.g_camControl = new PolarCamera(this.terrainmarch, cpos, cangX, cangY);
