...
class SimplePlane implements HieghtField {
	 ...
	 * 
	 */
	private terrainmarch SimplePlane;
	...
	public PVector GetMaterial(PVector p, PVector n) {
		float b = SimplePlane.noise(terrainmarch.floor(p.x),
				terrainmarch.floor(p.z));
		return SimplePlane.lerp(new PVector(1.0f, 0.0f, 0.2f), new PVector(1.f,
				1.f, 0.5f), b);
	}
