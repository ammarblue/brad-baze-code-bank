 ...
 */
public class m_NumberMixedRadix extends Number {
	//
	 ...
	 *            number
	 */
	public m_NumberMixedRadix(long value, int[] radices) {
		this.value = value;
	 ...
	 *            number
	 */
	public m_NumberMixedRadix(long value, List<Integer> radices) {
		this.value = value;
	 ...
	 */
	public m_NumberMixedRadix(int[] radixValues, int[] radices) {
		this(0, radices);
