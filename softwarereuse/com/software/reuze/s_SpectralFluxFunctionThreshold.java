...
public class s_SpectralFluxFunctionThreshold {
	/** the history size **/
	...
	/** Constructor, sets the history size in number of spectra to take into account to calculate the average spectral flux at a
	 * specific position. Also sets the multiplier to multiply the average with.
	 * 
	 * @param historySize The history size.
	 * @param multiplier The average multiplier. */
	public s_SpectralFluxFunctionThreshold (int historySize, float multiplier) {
