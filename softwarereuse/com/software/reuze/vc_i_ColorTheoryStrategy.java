 ...
 */
public interface vc_i_ColorTheoryStrategy {

    /**
     * Creates a new {@link vc_ColorList} of colors for the supplied source color
     ...
     */
    vc_ColorList createListFromColor(z_Colors src);
