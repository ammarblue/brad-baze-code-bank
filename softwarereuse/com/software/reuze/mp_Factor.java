...
public interface mp_Factor {
	 ...
	 * Factor.
	 * 
	 * @see mp_Factor#iterateOver(Iterator)
	 * @see mp_Factor#iterateOver(Iterator, mp_PropositionTermOpsAssignment...)
	 */
	 ...
	 */
	Set<mp_i_RandomVariable> getArgumentVariables();
	 ...
	 *         otherwise.
	 */
	boolean contains(mp_i_RandomVariable rv);
	 ...
	 */
	mp_Factor sumOut(mp_i_RandomVariable... vars);
	 ...
	 * 
	 * @see mp_Factor#pointwiseProductPOS(mp_Factor, mp_i_RandomVariable...)
	 */
	mp_Factor pointwiseProduct(mp_Factor multiplier);
	 ...
	 * 
	 * @see mp_Factor#pointwiseProduct(mp_Factor)
	 */
	mp_Factor pointwiseProductPOS(mp_Factor multiplier,
	 ...
	 *            this Factor.
	 */
	void iterateOver(Iterator fi, mp_PropositionTermOpsAssignment... fixedValues);
}
