 ...
 * @author Kevin Glass
 */
public class ga_ShapeRectangle extends ga_a_Shape {
	 ...
	 */
	public ga_ShapeRectangle(float x, float y, float width, float height) {
		this.x = x;
		this.y = y;
		this.width = width;
		this.height = height;
	 ...
	 */
	public void setBounds(ga_ShapeRectangle other) {
	...
	public boolean intersects(ga_a_Shape shape) {
        if(shape instanceof ga_ShapeRectangle) {
            ga_ShapeRectangle other = (ga_ShapeRectangle)shape;
        ...
        else if(shape instanceof ga_ShapeCircle) {
            return intersects((ga_ShapeCircle)shape);
        }
        else {
	 ...
	 */
	private boolean intersects(ga_ShapeCircle other) {
