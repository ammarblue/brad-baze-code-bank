 ...
 */
public class m_Noise implements m_i_Function1D, m_i_Function2D, m_i_Function3D {
	...
	public static void normalize2(float v[]) {
	 ...
	 */
	public static float[] findRange(m_i_Function1D f, float[] minmax) {
		if (minmax == null)
			minmax = new float[2];
		float min = 0, max = 0;
	 ...
	 * normalising the function.
	 */
	public static float[] findRange(m_i_Function2D f, float[] minmax) {
		if (minmax == null)
			minmax = new float[2];
		float min = 0, max = 0;
		// Some random numbers here...
