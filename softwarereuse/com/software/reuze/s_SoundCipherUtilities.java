 ...
 */
public class s_SoundCipherUtilities {
    ...
    /** 
     * Returns a pseudo-random number dispersed by a gaussian distribution 
     ...
     * range.
     * 
     * @param mean    the center value that should be most commonly returned 
     *                     by this method.
     * @param stdDeviation the breadth of variation either side of the mean.
     */
     ...
     *
     * @return The randomly chosen pitch that meets all constraints.
     */
    ...
    /**
     * Select a constrained MIDI pitch from a pitch class that is approximate to
 ...
 /**
     ...
     * are defined in the PitchClassSets interface.
     *
     * @param startVal The median point around which values will center
     * @param stdDeviation The standard deviation from the center/median point
     * @param pitchClassSet The scale or mode that the selected pitch must belong too
    ...
    /**
     * A helper class for the pitch class methods that determines if a pitch belongs
     * to a specified pitch class set or not.
     * A pitch class set is a float array of scale degree values in the range
     * from 0 to 11. There are some pitch class sets for common scales and modes
     * are defined in the PitchClassSets interface.
     *
     * @param val The MIDI pitch value to be tested
     * @param pitchClassSet The scale/mode that the value is tested against
     *
     * @return Whether or not the pitch belongs to the pitch class set.
     */
