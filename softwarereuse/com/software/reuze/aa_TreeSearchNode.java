 ...
 */
public class aa_TreeSearchNode {

	// n.STATE: the state in the state space to which the node corresponds;
	private Object state;

	// n.PARENT: the node in the search tree that generated this node;
	private aa_TreeSearchNode parent;
	 ...
	 */
	public aa_TreeSearchNode(Object state) {
		this.state = state;
		this.pathCost = 0.0;
	}
	 ...
	 *            parent's path cost.
	 */
	public aa_TreeSearchNode(Object state, aa_TreeSearchNode parent, aa_i_Action action, double stepCost) {
		this(state);
		this.parent = parent;
		this.action = action;
	 ...
	 */
	public aa_TreeSearchNode getParent() {
		return parent;
	}
	 ...
	 */
	public List<aa_TreeSearchNode> getPathFromRoot() {
		List<aa_TreeSearchNode> path = new ArrayList<aa_TreeSearchNode>();
		aa_TreeSearchNode current = this;
