 ...
 * @author Mark
 */
public abstract class ga_a_Shape implements Serializable {
     ...
     * @return The transformed shape.
     */
    public abstract ga_a_Shape transform(ga_ShapeTransform transform);
     ...
     */
    public void setLocation(ga_Vector2 loc) {
    	setX(loc.x);
    	setY(loc.y);
    }
    ...
    /**
     * Get the point closet to the center of all the points in this ga_a_Shape
     * 
     ...
     * within this one.
     */
    public boolean contains(ga_a_Shape other) {
    ...
    public boolean includes(float x, float y) {
    	...
    	ga_ShapeLine testLine = new ga_ShapeLine(0,0,0,0);
    ...
    public void increaseTriangulation() {
    	...
    	tris = new ga_TriangulatorOver(tris);
    }
     ...
     */
    public ga_i_Triangulator getTriangles() {
        checkPoints();
        calculateTriangles();
    	return tris;
    }
     ...
     */
    public ga_a_Shape prune() {
    	ga_ShapePolygon result = new ga_ShapePolygon();
     ...
     */
    public ga_a_Shape[] subtract(ga_a_Shape other) {
    	return new ga_ShapeOps().subtract(this, other);
    }
     ...
     * @return The newly created set of shapes resulting from the operation
     */
    public ga_a_Shape[] union(ga_a_Shape other) {
    	return new ga_ShapeOps().union(this, other);
    }
