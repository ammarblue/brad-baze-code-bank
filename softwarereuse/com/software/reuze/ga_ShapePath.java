 ...
 * @author kevin
 */
public class ga_ShapePath extends ga_a_Shape {
	 ...
	 * @param sx The start x coordinate of the path
 	 * @param sy The start y coordinate of the path
	 */
	public ga_ShapePath(float sx, float sy) {
	...
	/**
	 * Add a curve to the specified location (specifying the number of segments)
	 * 
	 * @param x The destination x coordinate
	 * @param y The destination y coordinate
	 * @param cx1 The x coordinate of the first control point
	...
	public void curveTo(float x, float y, float cx1, float cy1, float cx2, float cy2, int segments) {
		...
		ga_ShapeCurve curve = new ga_ShapeCurve(new ga_Vector2(cx,cy),new ga_Vector2(cx1,cy1),new ga_Vector2(cx2,cy2),new ga_Vector2(x,y));
		float step = 1.0f / segments;
		
		for (int i=1;i<segments+1;i++) {
			float t = i * step;
			ga_Vector2 p = curve.pointAt(t);
			if (hole != null) {
	...
	/**
	 * @see org.newdawn.slick.geom.ga_a_Shape#transform(org.newdawn.slick.geom.ga_ShapeTransform)
	 */
	public ga_a_Shape transform(ga_ShapeTransform transform) {
		ga_ShapePath p = new ga_ShapePath(cx,cy);
	...
	/**
	 * ga_ShapeTransform a list of points
	 * 
	 * @param pts The pts to transform
	 * @param t The transform to apply
	 * @return The transformed points
	 */
	private ArrayList transform(ArrayList pts, ga_ShapeTransform t) {
