...
/**
 * A polygon implementation meeting the <code>ga_a_Shape</code> contract. 
 * 
 * @author Mark
 */
public class ga_ShapePolygon extends ga_a_Shape {
     ...
     */
    public ga_ShapePolygon(float... points) {
    ...
    public ga_a_Shape transform(ga_ShapeTransform transform) {
        ...
        ga_ShapePolygon resultPolygon = new ga_ShapePolygon();
    ...
    /**
     * @see org.newdawn.slick.geom.ga_a_Shape#setX(float)
     */
    ...
    /**
     * @see org.newdawn.slick.geom.ga_a_Shape#setY(float)
     */
