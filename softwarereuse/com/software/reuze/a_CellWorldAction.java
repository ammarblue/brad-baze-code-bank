 ...
 * 
 */
public enum a_CellWorldAction implements aa_i_Action {
	Up, Down, Left, Right, None;

	private static final Set<a_CellWorldAction> _actions = new LinkedHashSet<a_CellWorldAction>();
	static {
		_actions.add(Up);
		_actions.add(Down);
		_actions.add(Left);
	 ...
	 */
	public static final Set<a_CellWorldAction> actions() {
		return _actions;
	}
	 ...
	 */
	public a_CellWorldAction getFirstRightAngledAction() {
		a_CellWorldAction a = null;
	 ...
	 */
	public a_CellWorldAction getSecondRightAngledAction() {
		a_CellWorldAction a = null;
