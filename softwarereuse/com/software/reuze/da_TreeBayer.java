...
public class da_TreeBayer<Key extends Comparable<Key>, Value>  {
    ...
    // constructor
    public da_TreeBayer() { root = new Node(0); }
    ...
    *************************************************************************/
    public static void main(String[] args) {
        da_TreeBayer<String, String> st = new da_TreeBayer<String, String>();
