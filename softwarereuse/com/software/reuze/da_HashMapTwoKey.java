 ...
 */
public class da_HashMapTwoKey<K1, K2, V> extends HashMap<d_Pair<K1, K2>, V> {
	...
	public void put(K1 key1, K2 key2, V value) {
		super.put(new d_Pair<K1, K2>(key1, key2), value);
	}
	...
	public V get(K1 key1, K2 key2) {
		return super.get(new d_Pair<K1, K2>(key1, key2));
	}
	...
	public boolean containsKey(K1 key1, K2 key2) {
		return super.containsKey(new d_Pair<K1, K2>(key1, key2));
	}
	...
	public V remove(K1 key1, K2 key2) {
		return super.remove(new d_Pair<K1, K2>(key1, key2));
	}
