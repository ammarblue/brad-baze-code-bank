 ...
 * @author Ravi Mohan
 */
public class ga_CellPositionAndContent<C> {
	private int x = 1;
	private int y = 1;
	 ...
	 */
	public ga_CellPositionAndContent(int x, int y, C content) {
		this.x = x;
		this.y = y;
	...
	public boolean equals(Object o) {
		if (o instanceof ga_CellPositionAndContent<?>) {
			ga_CellPositionAndContent<?> c = (ga_CellPositionAndContent<?>) o;
