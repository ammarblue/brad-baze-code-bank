...
/**
 * For each neighbor it's computed the difference between the processed cell and
 * the neighbor:
 * 
 * <pre>
 * d[i] = h - h[i];
 ...
 * positive differences that are bigger than T (this number is n), the talus
 ...
 */
public class ga_ErosionFunctionTalusAngle extends ga_a_ErosionFunction {
     ...
     */
    public ga_ErosionFunctionTalusAngle(float theta, float amount) {
        this.theta = theta;
        this.amount = amount;
    }
