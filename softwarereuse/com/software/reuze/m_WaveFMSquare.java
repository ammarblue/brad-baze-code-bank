 ...
 * </p>
 */
public class m_WaveFMSquare extends m_a_Wave {

    public m_a_Wave fmod;

    public m_WaveFMSquare(float phase, float freq, m_a_Wave fmod) {
        super(phase, freq);
        this.fmod = fmod;
    }
     ...
     * @param offset
     */
    public m_WaveFMSquare(float phase, float freq, float amp, float offset) {
     ...
     */
    public float update() {
        value = (phase / m_MathUtils.TWO_PI < 0.5 ? 1 : -1) * amp + offset;
