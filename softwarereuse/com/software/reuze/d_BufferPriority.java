 ...
 * @author Steve Phelps
 */
public class d_BufferPriority extends AbstractCollection
        implements d_i_Buffer, Serializable {
     ...
     */
    public d_BufferPriority(Comparator comparator) {
     ...
     */
    public d_BufferPriority(boolean ascendingOrder) {
     ...
     *  null means use natural order
     */
    public d_BufferPriority(boolean ascendingOrder, Comparator comparator) {
     ...
     */
    public d_BufferPriority(int capacity) {
     ...
     * @throws IllegalArgumentException if <code>capacity</code> is &lt;= <code>0</code>
     */
    public d_BufferPriority(int capacity, Comparator comparator) {
     ...
     * @throws IllegalArgumentException if <code>capacity</code> is <code>&lt;= 0</code>
     */
    public d_BufferPriority(int capacity, boolean ascendingOrder) {
     ...
     * @throws IllegalArgumentException if <code>capacity</code> is <code>&lt;= 0</code>
     */
    public d_BufferPriority(int capacity, boolean ascendingOrder, Comparator comparator) {
        super();
        if (capacity <= 0) {
     ...
     * @throws le_ExceptionBufferUnderflow if the buffer is empty
     */
    public Object get() {
        if (isEmpty()) {
            throw new le_ExceptionBufferUnderflow();
        } else {
            return elements[1];
        }
    }
