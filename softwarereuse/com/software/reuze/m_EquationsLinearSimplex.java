...
public class m_EquationsLinearSimplex {
    ...
    public m_EquationsLinearSimplex(double[][] A, double[] b, double[] c) {
        M = b.length;
        N = c.length;
   ...
   // index of a non-basic column with most positive cost
    ...
    public static void test(double[][] A, double[] b, double[] c) {
        m_EquationsLinearSimplex lp = new m_EquationsLinearSimplex(A, b, c);
    ...
    public static void main(String[] args) {
        ...
        for (int j = 0; j < N; j++)
            c[j] = m_RandomStd.uniform(1000);
        for (int i = 0; i < M; i++)
            b[i] = m_RandomStd.uniform(1000);
        for (int i = 0; i < M; i++)
            for (int j = 0; j < N; j++)
                A[i][j] = m_RandomStd.uniform(100);
        m_EquationsLinearSimplex lp = new m_EquationsLinearSimplex(A, b, c);
