 ...
 * 
 */
public class mf_KnowledgeBaseExamples {

	public static mf_KnowledgeBase createKingsKnowledgeBase(
			mf_i_InferenceProcedure infp) {
		mf_KnowledgeBase kb = new mf_KnowledgeBase(mf_DomainExamples.kingsDomain(),
				infp);
	...
	public static mf_KnowledgeBase createWeaponsKnowledgeBase(
			mf_i_InferenceProcedure infp) {
		mf_KnowledgeBase kb = new mf_KnowledgeBase(
				mf_DomainExamples.weaponsDomain(), infp);
	...
	public static mf_KnowledgeBase createLovesAnimalKnowledgeBase(
			mf_i_InferenceProcedure infp) {
		mf_KnowledgeBase kb = new mf_KnowledgeBase(
				mf_DomainExamples.lovesAnimalDomain(), infp);
	...
	public static mf_KnowledgeBase createRingOfThievesKnowledgeBase(
			mf_i_InferenceProcedure infp) {
		mf_KnowledgeBase kb = new mf_KnowledgeBase(
				mf_DomainExamples.ringOfThievesDomain(), infp);
	...
	public static mf_KnowledgeBase createABCEqualityKnowledgeBase(
			mf_i_InferenceProcedure infp, boolean includeEqualityAxioms) {
		mf_Domain domain = new mf_Domain();
		domain.addConstant("A");
		domain.addConstant("B");
		domain.addConstant("C");

		mf_KnowledgeBase kb = new mf_KnowledgeBase(domain, infp);
	...
	public static mf_KnowledgeBase createABCDEqualityAndSubstitutionKnowledgeBase(
			mf_i_InferenceProcedure infp, boolean includeEqualityAxioms) {
		mf_Domain domain = new mf_Domain();
		domain.addConstant("A");
		domain.addConstant("B");
