 ...
 * @version 1.2
 */
public interface gb_i_NurbsSurface {
     ...
     */
    gb_NurbsControlNet getControlNet();

    /**
     * Get a List of all TrimCurves associated with this Nurbs Surface
     * 
    ...
    public abstract gb_NurbsKnotVector getUKnotVector();
    ...
    public abstract gb_NurbsKnotVector getVKnotVector();

    public abstract gb_Vector3 pointOnSurface(double u, double v);

    /**
     * Calculate point on surface for the given u and v values
     * 
     * @param u
     *            u value to calculate point from
     * @param v
     *            v value to calculate point from
     * @return calculated point
     */
    gb_Vector3 pointOnSurface(float u, float v);
     ...
     */
    gb_Vector3 pointOnSurface(float u, float v, gb_Vector3 out);
