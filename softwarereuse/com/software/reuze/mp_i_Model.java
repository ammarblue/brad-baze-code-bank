...
public interface mp_i_Model {
	 ...
	 */
	double prior(mp_i_Proposition... phi);
	 ...
	 */
	double posterior(mp_i_Proposition phi, mp_i_Proposition... evidence);
	 ...
	 */
	Set<mp_i_RandomVariable> getRepresentation();
}