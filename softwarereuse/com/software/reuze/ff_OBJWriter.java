 ...
 * management. See {@link gb_TriangleMesh} for details.
 * 
 * Needs to get some more TLC in future versions.
 * 
 * @see gb_TriangleMesh#saveAsOBJ(OBJWriter)
 */
public class ff_OBJWriter {
    ...
    public void normal(gb_Vector3 n) {
        objWriter.println("vn " + n.x + " " + n.y + " " + n.z);
        numNormalsWritten++;
    }

    public void vertex(gb_Vector3 v) {
