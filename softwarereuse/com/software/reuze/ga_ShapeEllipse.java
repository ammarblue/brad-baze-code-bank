 ...
 * @author Mark
 */
public class ga_ShapeEllipse extends ga_a_Shape {
    /**
     ...
     */
    public ga_ShapeEllipse(float centerPointX, float centerPointY, float radius1, float radius2) {
     ...
     */
    public ga_ShapeEllipse(float centerPointX, float centerPointY, float radius1, float radius2, int segmentCount) {
