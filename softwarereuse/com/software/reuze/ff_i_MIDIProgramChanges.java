...
/** An interface storing General MIDI program change constants.
  ...
  * to relieve the programmer from having to look up the GM
  * specification for program change values.<br>
  ...
  * access constants using: sc.FLUTE<br>
  * after: SCSCore score = new SCScore();<br>
  * access constants using: score.FLUTE<br>
  * <br>
  * This class was borrowed from the jMusic library.
  *
  * @author Andrew Sorensen, Andrew Brown, Andrew Troedson, Adam Kirby
  */
public interface ff_i_MIDIProgramChanges {
