...
public class m_SplineFactory
{
  ...
  {
    m_a_Spline spline = new m_SplineBezier (controlPoints, nParts);
  ...
  {
    m_a_Spline spline = new m_SplineCubic (controlPoints, nParts);
    return spline.generate();
  }
  ...
  {
    m_a_Spline spline = new m_SplineCatmullRom (controlPoints, nParts);
    return spline.generate();
  }
  ...
  public static void main (String[] args)
  {
    ...
    double[] spline1 = m_SplineFactory.createBezier (c,     20);
    double[] spline2 = m_SplineFactory.createCubic (c,      20);
    double[] spline3 = m_SplineFactory.createCatmullRom (c, 20);        
