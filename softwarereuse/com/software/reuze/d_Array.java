 ...
 * @author Nathan Sweet */
public class d_Array<T> implements Iterable<T> { /*RPC0812*/
	...
	public d_Array (boolean ordered, int capacity) {
	 ...
	 *           memory copy.
	 * @param capacity Any elements added beyond this will cause the backing array to be grown. */
	public d_Array (boolean ordered, int capacity, Class<T> arrayType) {
		this.ordered = ordered;
	...
	public d_Array (Class<T> arrayType) {
	 ...
	 * @param ordered If false, methods that remove elements may change the order of other elements in the array, which avoids a
	 *           memory copy. */
	public d_Array (boolean ordered, T[] array) {
	...
	public void addAll (d_Array array) {
		addAll(array, 0, array.size);
	}

	public void addAll (d_Array array, int offset, int length) {
	 ...
	 * {@link Sort#instance()}). */
	public void sort () {
		//TODO Sort.instance().sort(items, 0, size);
	...
	static public class ArrayIterator<T> implements Iterator<T> {
		private final d_Array<T> array;
		int index;

		public ArrayIterator (d_Array<T> array) {
			this.array = array;
		}
	...
	static public class ArrayIterable<T> implements Iterable<T> {
		...
		public ArrayIterable (d_Array<T> array) {
