 ...
 */
public class dasg_SearchAdversarialIterativeDeepeningAlphaBeta<STATE extends Iterable<ACTION>, ACTION, PLAYER>
		implements dasg_i_SearchAdversarial<STATE, ACTION> {

	protected dg_i_Game<STATE, ACTION, PLAYER> game;
	...
	public static <STATE extends Iterable<ACTION>, ACTION, PLAYER> dasg_SearchAdversarialIterativeDeepeningAlphaBeta<STATE, ACTION, PLAYER> createFor(
			dg_i_Game<STATE, ACTION, PLAYER> game, double utilMin, double utilMax,
			int time) {
		return new dasg_SearchAdversarialIterativeDeepeningAlphaBeta<STATE, ACTION, PLAYER>(
				game, utilMin, utilMax, time);
	}

	public dasg_SearchAdversarialIterativeDeepeningAlphaBeta(dg_i_Game<STATE, ACTION, PLAYER> game,
