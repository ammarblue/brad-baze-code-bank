 ...
 */
public class gc_HyperspacePoint implements Serializable {
     ...
     */
    public gc_HyperspacePoint( double[] coords ) {
        // this.coords = coords;
     ...
     * @return HyperPoint
     */
    protected static gc_HyperspacePoint getNullHyperPoint( int dimension ) {
        double[] point = new double[dimension];
        for ( int i = 0; i < dimension; i++ )
            point[i] = Double.NaN;
        return new gc_HyperspacePoint( point );
    }
    ...
    public boolean equals( Object obj ) {
        gc_HyperspacePoint point = (gc_HyperspacePoint) obj;
        for ( int i = 0; i < coords.length; i++ ) {
