...
/** Contains information from a Tiled Map. Use {@link TiledLoader#createMap(f_Handle)} to fill it.
 * @author David Fraska */
public class ga_TiledMap {
	public ArrayList<ga_TiledLayer> layers = new ArrayList<ga_TiledLayer>(4);
	public ArrayList<ga_TiledObjectGroup> objectGroups = new ArrayList<ga_TiledObjectGroup>(1);
	public ArrayList<ga_TileSetEntry> tileSets = new ArrayList<ga_TileSetEntry>(5);
	...
	public InputStreamReader tmxFile;
	public String orientation;
	public int width, height, tileWidth, tileHeight;

	/** Sets a tile's property. Typically only called by {@link TiledLoader#createMap(f_Handle)}
