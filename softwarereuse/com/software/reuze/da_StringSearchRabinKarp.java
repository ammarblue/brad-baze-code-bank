...
public class da_StringSearchRabinKarp {
    ...
    public da_StringSearchRabinKarp(int R, char[] pattern) {
        throw new RuntimeException("Operation not supported yet");
    }

    public da_StringSearchRabinKarp(String pat) {
        R = 256;
        M = pat.length();
        Q = longRandomPrime();
        this.pat = pat;
    ...
    public static void main(String[] args) {
        ...
        da_StringSearchRabinKarp searcher = new da_StringSearchRabinKarp(pat);
