 ...
 * 
 */
public class aa_PolicyEvaluationModified<S, A extends aa_i_Action> implements aa_i_PolicyEvaluation<S, A> {
	 ...
	 *            discount &gamma; to be used
	 */
	public aa_PolicyEvaluationModified(int k, double gamma) {
