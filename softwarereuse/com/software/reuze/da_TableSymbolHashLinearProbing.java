...
public class da_TableSymbolHashLinearProbing<Key, Value> {
    ...
    public da_TableSymbolHashLinearProbing() {
        this(INIT_CAPACITY);
    }

    // create linear proving hash table of given capacity
    public da_TableSymbolHashLinearProbing(int capacity) {
        M = capacity;
    ...
    private void resize(int capacity) {
        da_TableSymbolHashLinearProbing<Key, Value> temp = new da_TableSymbolHashLinearProbing<Key, Value>(capacity);
        for (int i = 0; i < M; i++) {
            if (keys[i] != null) {
...
/***********************************************************************
    ...
    ***********************************************************************/
    public static void main(String[] args) { 
        da_TableSymbolHashLinearProbing<String, Integer> st = new da_TableSymbolHashLinearProbing<String, Integer>();
