...
public class as_SimulationDiscrete {
	static AtomicInteger nThreads=new AtomicInteger(), bThreads=new AtomicInteger();
	...
	public static void Hold (double delay) {
		...
		if (delay != 0) System.out.println("time="+as_SimulationThread.clock+" delaying "+t);
	...
	public static void newThread() {
		as_SimulationThread t=(as_SimulationThread)Thread.currentThread();
		System.out.println("time="+as_SimulationThread.clock+" starting "+t);
		t.setPriority(2);
	...
	public static void stopThread() {
		...
		System.out.println("time="+as_SimulationThread.clock+" ending "+t);	
	}
	private static class T extends Thread {
		...
		@Override
		public void run() {
			while (as_SimulationThread.clock==0 && (bThreads.intValue()==0 || bThreads.intValue()<nThreads.intValue()))
				try {
					sleep(1);
