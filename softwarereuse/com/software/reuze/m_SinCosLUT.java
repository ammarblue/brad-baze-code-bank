 ...
 */
public final class m_SinCosLUT {
    ...
    private static m_SinCosLUT DEFAULT_INSTANCE;

    public static final m_SinCosLUT getDefaultInstance() {
        if (DEFAULT_INSTANCE == null) {
            DEFAULT_INSTANCE = new m_SinCosLUT();
        }
    ...
    public m_SinCosLUT(float precision) {
