 ...
 * @author Andrew Brown
 */
public class d_PropertyListPair<E> implements Cloneable {
     ...
     * @param value
     */
    public d_PropertyListPair(String name, E value) {
        this.name = name;
        this.value = value;
    }
     ...
     * @param value
     */
    public d_PropertyListPair(E value) {
    ...
    public boolean equals(Object obj) {
        ...
        final d_PropertyListPair<E> other = (d_PropertyListPair<E>) obj;
     ...
     */
    @Override
    public d_PropertyListPair<E> clone() {
        d_PropertyListPair<E> copy = new d_PropertyListPair(this.getName(), this.getValue());
        return copy;
    }
}
