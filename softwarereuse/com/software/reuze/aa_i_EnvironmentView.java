 ...
 */
public interface aa_i_EnvironmentView {
	/**
	 ...
	 *            to the Environment.
	 */
	void agentAdded(aa_i_Agent agent, aa_i_EnvironmentState resultingState);
	 ...
	 *            the Environment.
	 */
	void agentActed(aa_i_Agent agent, aa_i_Action action, aa_i_EnvironmentState resultingState);
}
