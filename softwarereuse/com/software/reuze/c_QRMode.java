...
public enum c_QRMode {
  ...
  c_QRMode(int[] characterCountBitsForVersions, int bits) {
   ...
   */
  public static c_QRMode forBits(int bits) {
    switch (bits) {
      case 0x0:
        return TERMINATOR;
      case 0x1:
   ...
   * @return number of bits used, in this QR Code symbol {@link c_QRVersion}, to encode the
   *         count of characters that will follow encoded in this Mode
   */
  public int getCharacterCountBits(c_QRVersion version) {
