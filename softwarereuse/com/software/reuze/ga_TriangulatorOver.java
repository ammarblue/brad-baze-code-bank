 ...
 * @author kevin
 */
public class ga_TriangulatorOver implements ga_i_Triangulator {
	/** The triangles data */
	 ...
	 * 
	 * @param tris The original set of triangles to be sub-divided
	 */
	public ga_TriangulatorOver(ga_i_Triangulator tris) {
