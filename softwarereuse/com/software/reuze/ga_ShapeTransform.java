...
/**   
 * A 2 dimensional transformation that can be applied to <code>Shape</code> implementations.   
 *    
 * @author Mark   
 */   
public class ga_ShapeTransform {   
    /**   
     ...
     */   
    public ga_ShapeTransform(ga_ShapeTransform other) {   
     ...
     */
    public ga_ShapeTransform(ga_ShapeTransform t1, ga_ShapeTransform t2) {
    	this(t1);
    	concatenate(t2);
    }
     ...
     */   
    public ga_ShapeTransform(float matrixPosition[]) {   
     ...
     */   
    public ga_ShapeTransform(float point00, float point01, float point02, float point10, float point11, float point12) {   
     ...
     */   
    public ga_ShapeTransform concatenate(ga_ShapeTransform tx) {   
...
//        
     ...
     * @return The resulting Transform   
     */   
    public static ga_ShapeTransform createRotateTransform(float angle) {   
        return new ga_ShapeTransform((float)Math.cos(angle), -(float)Math.sin(angle), 0, (float)Math.sin(angle), (float)Math.cos(angle), 0);   
    }   
     ...
     * @return The resulting Transform   
     */   
    public static ga_ShapeTransform createRotateTransform(float angle, float x, float y) {   
        ga_ShapeTransform temp = ga_ShapeTransform.createRotateTransform(angle);
     ...
     * @return The resulting Transform   
     */   
    public static ga_ShapeTransform createTranslateTransform(float xOffset, float yOffset) {   
        return new ga_ShapeTransform(1, 0, xOffset, 0, 1, yOffset);   
    }   
     ...
     * @return The resulting Transform   
     */   
    public static ga_ShapeTransform createScaleTransform(float xScale, float yScale) {   
        return new ga_ShapeTransform(xScale, 0, 0, 0, yScale, 0);   
    }
     ...
     */
    public ga_Vector2 transform(ga_Vector2 pt) {
    	float[] in = new float[] {pt.x, pt.y};
    	float[] out = new float[2];
    	
    	transform(in, 0, out, 0, 1);
    	
    	return new ga_Vector2(out[0], out[1]);
    }
}   