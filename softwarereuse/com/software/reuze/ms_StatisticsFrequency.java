 ...
 *
 * @version $Revision: 791733 $ $Date: 2009-07-07 03:44:52 -0400 (Tue, 07 Jul 2009) $
 */
public class ms_StatisticsFrequency implements Serializable {
     ...
     */
    public int addValue(Comparable<?> v){
        if (v instanceof Number) {
			v = Double.valueOf(round(((Number)v).doubleValue(),places));
        }
        try {
