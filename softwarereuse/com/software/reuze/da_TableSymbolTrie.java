...
public class da_TableSymbolTrie<Value> {
    ...
    ****************************************************/
    ...
    public Iterable<String> keysWithPrefix(String prefix) {
        d_Queue<String> queue = new d_Queue<String>();
        Node x = get(root, prefix, 0);
        collect(x, prefix, queue);
        return queue;
    }

    private void collect(Node x, String key, d_Queue<String> queue) {
        if (x == null) return;
    ...
    public Iterable<String> keysThatMatch(String pat) {
        d_Queue<String> q = new d_Queue<String>();
        collect(root, "", pat, q);
        return q;
    }
 
    public void collect(Node x, String prefix, String pat, d_Queue<String> q) {
        if (x == null) return;
    ...
    public static void main(String[] args) {
        ...
        da_TableSymbolTrie<Integer> st = new da_TableSymbolTrie<Integer>();
