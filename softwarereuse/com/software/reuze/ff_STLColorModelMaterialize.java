...
public class ff_STLColorModelMaterialize implements ff_i_STLColorModel {

    protected int baseColor;
    protected boolean useFacetColors;

    public ff_STLColorModelMaterialize(int rgb) {
        this(rgb, false);
    }

    public ff_STLColorModelMaterialize(int rgb, boolean enableFacets) {
        baseColor = rgb;
