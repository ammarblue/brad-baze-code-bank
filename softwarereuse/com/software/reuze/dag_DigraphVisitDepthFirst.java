 ...
 *
 *  Compute preorder and postorderfor a digraph or edge-weighted digraph.
 *  Runs in O(E + V) time.
 *
 *
 *************************************************************************/
...
public class dag_DigraphVisitDepthFirst {
    ...
    public dag_DigraphVisitDepthFirst(dag_Digraph G) {
        pre    = new int[G.V()];
        post   = new int[G.V()];
    ...
    public dag_DigraphVisitDepthFirst(dag_DigraphEdgeWeighted G) {
        pre    = new int[G.V()];
        post   = new int[G.V()];
        postorder = new d_Queue<Integer>();
        preorder  = new d_Queue<Integer>();
