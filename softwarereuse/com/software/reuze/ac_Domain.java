...
import com.software.reuze.d_ArrayIterator;
 ...
 */
public class ac_Domain implements Iterable<Object> {

	private Object[] values;

	public ac_Domain(List<?> values) {
		this.values = new Object[values.size()];
		for (int i = 0; i < values.size(); i++)
			this.values[i] = values.get(i);
	}

	public ac_Domain(Object[] values) {
	...
	public Iterator<Object> iterator() {
		return new d_ArrayIterator<Object>(values);
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof ac_Domain) {
			ac_Domain d = (ac_Domain) obj;
