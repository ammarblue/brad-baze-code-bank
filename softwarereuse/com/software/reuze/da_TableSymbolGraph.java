...
public class da_TableSymbolGraph {
    private d_TableSymbol<String, Integer> st;  // string -> index
    private String[] keys;           // index  -> string
    private dag_GraphIntegers G;

    public da_TableSymbolGraph(String filename, String delimiter) {
    ...
    public static void main(String[] args) {
        ...
        da_TableSymbolGraph sg = new da_TableSymbolGraph(filename, delimiter);
