 ...
 * </pre>
 */
public class gb_StrategySubdivisionDisplacementMidpoint extends gb_StrategySubdivisionDisplacement {

    public gb_Vector3 centroid;

    public gb_StrategySubdivisionDisplacementMidpoint(gb_Vector3 centroid, float amount) {
        super(amount);
    ...
    public List<gb_Vector3> computeSplitPoints(gb_WEWingedEdge edge) {
        ...
        // Vector3 mid = edge.a.interpolateTo(edge.b, 0.25f);
        gb_Vector3 n = mid.tmp().sub(centroid).norTo(amp * edge.getLength());
        List<gb_Vector3> points = new ArrayList<gb_Vector3>(1);
