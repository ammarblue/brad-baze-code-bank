 ...
 * @author Ravi Mohan
 */
public class mp_HMMInferenceForwardBackward implements mpt_i_InferenceForwardBackward {

	protected mp_i_HMM hmm = null;

	public mp_HMMInferenceForwardBackward(mp_i_HMM hmm) {
		this.hmm = hmm;
	}
	...
	public List<mp_i_CategoricalDistributionIterator> forwardBackward(
		...
		// local variables: fv, a vector of forward messages for steps 0,...,t
		List<m_Matrix> fv = new ArrayList<m_Matrix>(ev.size() + 1);
		// b, a representation of the backward message, initially all 1s
	 ...
	 */
	public m_Matrix backward(m_Matrix b_kp2t, m_Matrix O_kp1) {
