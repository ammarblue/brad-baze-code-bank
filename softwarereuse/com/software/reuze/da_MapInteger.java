...
public class da_MapInteger<V> {
	 ...
	 * backing table. */
	public da_MapInteger () {
		this(32, 0.8f);
	}

	/** Creates a new map with a load factor of 0.8. This map will hold initialCapacity * 0.8 items before growing the backing
	 * table. */
	public da_MapInteger (int initialCapacity) {
		this(initialCapacity, 0.8f);
	}

	/** Creates a new map with the specified initial capacity and load factor. This map will hold initialCapacity * loadFactor items
	 * before growing the backing table. */
	public da_MapInteger (int initialCapacity, float loadFactor) {
	...
	public void putAll (da_MapInteger<V> map) {
	...
	static private class MapIterator<V> {
		...
		final da_MapInteger<V> map;
		int nextIndex, currentIndex;

		public MapIterator (da_MapInteger<V> map) {
			this.map = map;
			reset();
		}
	...
	static public class Entries<V> extends MapIterator<V> implements Iterable<Entry<V>>, Iterator<Entry<V>> {
		...
		public Entries (da_MapInteger map) {
			super(map);
		}
	...
	static public class Values<V> extends MapIterator<V> implements Iterable<V>, Iterator<V> {
		public Values (da_MapInteger<V> map) {
			super(map);
		}
	...
	static public class Keys extends MapIterator {
		...
		/** Returns a new array containing the remaining values. */
		public d_ArrayIntsEfficientRemove toArray () {
			d_ArrayIntsEfficientRemove array = new d_ArrayIntsEfficientRemove(true, map.size);
			while (hasNext)
				array.add(next());
			return array;
		}
