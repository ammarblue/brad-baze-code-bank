 ...
 * subclasses of {@link d_MapExtendable} with road map data from Australia. The
 * data was extracted from a class developed by Felix Knittel.
 * 
 * @author Ruediger Lunde
 */
public class d_MapAustraliaRoadsSimplified extends d_MapExtendable {

	public d_MapAustraliaRoadsSimplified() {
		initMap(this);
	}
	 ...
	 */
	public static void initMap(d_MapExtendable map) {
		map.clear();
		// Add links
