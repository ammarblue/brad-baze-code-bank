...
public interface aa_i_Environment {
	 ...
	 */
	void addAgent(aa_i_Agent agent);
	 ...
	 */
	void removeAgent(aa_i_Agent agent);
	 ...
	 */
	List<aa_i_EnvironmentObject> getEnvironmentObjects();
	 ...
	 */
	void addEnvironmentObject(aa_i_EnvironmentObject eo);
	 ...
	 */
	void removeEnvironmentObject(aa_i_EnvironmentObject eo);
	 ...
	 */
	double getPerformanceMeasure(aa_i_Agent forAgent);
	 ...
	 */
	void addEnvironmentView(aa_i_EnvironmentView ev);
	 ...
	 */
	void removeEnvironmentView(aa_i_EnvironmentView ev);
