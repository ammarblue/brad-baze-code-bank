 ...
 */
public class das_TreeAstar extends das_TreeBestFirst {
	 ...
	 *            goal state.
	 */
	public das_TreeAstar(aa_TreeSearchNodeExpanderQueue search, m_i_HeuristicFunction hf) {
		super(search, new das_TreeAstarEvaluationFunction(hf));
	}
}