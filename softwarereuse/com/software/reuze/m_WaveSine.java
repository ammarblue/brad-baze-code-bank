 ...
 */
//@XmlRootElement
public class m_WaveSine extends m_a_Wave {
     ...
     */
    public m_WaveSine(float phase, float freq) {
        super(phase, freq);
    }
     ...
     *            amplitude factor
     * @param offset
     *            center oscillation value
     */
    public m_WaveSine(float phase, float freq, float amp, float offset) {
