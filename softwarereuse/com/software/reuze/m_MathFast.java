...
public class m_MathFast {
    ...
    public static double acosh(final double a) {
        return m_MathFast.log(a + m_MathFast.sqrt(a * a - 1));
    }
    ...
    public static double asinh(double a) {
        ...
        double absAsinh;
        if (a > 0.167) {
            absAsinh = m_MathFast.log(m_MathFast.sqrt(a * a + 1) + a);
        } else {
            final double a2 = a * a;
            if (a > 0.097) {
    ...
    public static double atanh(double a) {
        ...
        double absAtanh;
        if (a > 0.15) {
            absAtanh = 0.5 * m_MathFast.log((1 + a) / (1 - a));
        } else {
            final double a2 = a * a;
            if (a > 0.087) {
