...
public class ce_CipherAes extends ce_a_CipherBlock
    {
    ...
    public ce_CipherAes( String keyStr )
	{
	...
	ce_a_CipherBlock aesa = new ce_CipherAes( "0123456789" );
	byte[] clearText1 = {
	...
	ce_a_CipherBlock aesb = new ce_CipherAes( "abcdefghijklmnopqrstuvwxyz" );
	byte[] clearText2 = {
