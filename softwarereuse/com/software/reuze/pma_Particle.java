...
//TODO import java.awt.Color;


public class pma_Particle {
  ...
  //TODOprivate Color color;      // color
    private int count;        // number of collisions so far


    // create a new particle with given parameters        
    public pma_Particle(double rx, double ry, double vx, double vy, double radius, double mass, int colorARGB) {
        this.vx = vx;
        this.vy = vy;
        this.rx = rx;
        this.ry = ry;
    ...
    // draw the particle
    public void draw() {
    	//TODOvgu_StdDraw.setPenColor(color);
    	//TODOvgu_StdDraw.filledCircle(rx, ry, radius);
    }
    ...
    public double timeToHit(pma_Particle b) {
    	pma_Particle a = this;
    ...
    public void bounceOff(pma_Particle that) {
