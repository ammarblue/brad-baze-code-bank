...
public interface mp_i_Proposition {
	 ...
	 *         is being sought.
	 */
	Set<mp_i_RandomVariable> getUnboundScope();
	 ...
	 *         otherwise.
	 */
	boolean holds(Map<mp_i_RandomVariable, Object> possibleWorld);
}