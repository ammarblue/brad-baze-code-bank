 ...
 * @version 1.0
 */
public class gb_NurbsKnotVector {
     ...
     *            degree of Nurbs
     */
    public gb_NurbsKnotVector(float knots[], int degree)
     ...
     * @return an array of basis function values or derived basis functions
     *         values. The first array is the degree of derivation in the
     ...
     * 
     */
    public float[][] deriveBasisFunctions(float u, int grade) {
        int span = findSpan(u);
        return deriveBasisFunctions(span, u, grade);
    }
     ...
     *         values
     * @see gb_NurbsKnotVector#derivBasisFunctions(float, int)
     */
    public float[][] deriveBasisFunctions(int span, float u, int grade) {
