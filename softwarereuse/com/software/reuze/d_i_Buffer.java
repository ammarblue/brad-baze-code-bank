...
import com.software.reuze.le_ExceptionBufferUnderflow;
 ...
 */
public interface d_i_Buffer extends Collection {

    /**
     * Gets and removes the next object from the buffer.
     *
     * @return the next object in the buffer, which is also removed
     * @throws le_ExceptionBufferUnderflow if the buffer is already empty
     */
    Object remove();
