 ...
 */
public interface dg_i_Game<STATE extends Iterable<ACTION>, ACTION, PLAYER> { /*RPC0912*/
	...
	List<ACTION> getActions(STATE state); //provides the choice of accessing all possibilities
...
/*RPC0912 adding Iterable provides same result as getActions() but avoids having to generate all choices beforehand*/
