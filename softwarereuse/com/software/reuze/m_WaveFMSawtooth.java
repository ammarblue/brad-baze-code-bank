 ...
 * </p>
 */
public class m_WaveFMSawtooth extends m_a_Wave {

    public m_a_Wave fmod;

    public m_WaveFMSawtooth(float phase, float freq, m_a_Wave fmod) {
        super(phase, freq);
        this.fmod = fmod;
    }
     ...
     * @param offset
     */
    public m_WaveFMSawtooth(float phase, float freq, float amp, float offset) {
     ...
     * 
     * @see m_a_Wave.math.waves.m_a_WaveAbstract#reset()
     */
    public void reset() {
        super.reset();
        fmod.reset();
     ...
     * 
     * @see m_a_Wave.math.waves.m_a_WaveAbstract#update()
     */
    public float update() {
        value = ((phase / m_MathUtils.TWO_PI) * 2 - 1) * amp + offset;
