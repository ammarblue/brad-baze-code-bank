 ...
 * subclasses of {@link d_MapExtendable} with road map data from Romania. Location
 ...
 */
public class d_MapRomaniaRoadsSimplified extends d_MapExtendable {

	public d_MapRomaniaRoadsSimplified() {
		initMap(this);
	}
