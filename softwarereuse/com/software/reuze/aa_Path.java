 ...
 * @author Andrew Brown
 */
public class aa_Path extends LinkedList<Object> {
         ...
         */
        public aa_Path append(Object... states) {
                aa_Path appendedPath = new aa_Path();
         ...
         */
        public aa_Path prepend(Object state) {
                aa_Path prependedPath = new aa_Path();
