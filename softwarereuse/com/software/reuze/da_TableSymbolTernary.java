...
public class da_TableSymbolTernary<Value> {
    private int N;       // size
    ...
    **************************************************************/
    ...
    private void collect(Node x, String prefix, d_Queue<String> queue) {
        if (x == null) return;
    ...
    public void collect(Node x, String prefix, int i, String pat, d_Queue<String> q) {
        if (x == null) return;
        char c = pat.charAt(i);
    ...
    public static void main(String[] args) {
        ...
        da_TableSymbolTernary<Integer> st = new da_TableSymbolTernary<Integer>();
