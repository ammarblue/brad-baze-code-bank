...
public abstract class va_a_AnimationController {
	...
	protected va_a_Animation mCurrentAnim = null;
	...
	/** Sets the currently playing {@link va_a_Animation}.
	 * @param anim The animation to play.
	 * @param mode The animation's {@link WrapMode}. */
	public void setAnimation (va_a_Animation anim, WrapMode mode) {
		mCurrentAnim = anim;
		mWrapMode = mode;
	...
	/** Gets the currently playing {@link va_a_Animation}.
	 * @return the current animation. */
	public va_a_Animation getCurrentAnimation () {
		return mCurrentAnim;
	}
