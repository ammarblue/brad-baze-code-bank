 ...
 */
public class da_GeneticAlgorithm {
	//
	protected d_Metrics metrics = new d_Metrics();
	...
	public da_GeneticAlgorithm(int individualLength,
	...
	public String geneticAlgorithm(Set<String> population,
			a_i_FitnessFunction fitnessFn, a_i_GoalTest goalTest) {
	...
	// FITNESS-FN, a function that measures the fitness of an individual
	public String geneticAlgorithm(Set<String> population,
			a_i_FitnessFunction fitnessFn, int iterations) {
		String bestIndividual = null;
	...
	private String ga(Set<String> population, a_i_FitnessFunction fitnessFn) {
		// new_population <- empty set
	...
	private String randomSelection(Set<String> population,
		...
		fValues = a_Utils.normalize(fValues);
