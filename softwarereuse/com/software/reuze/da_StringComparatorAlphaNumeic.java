 ...
 */
public class da_StringComparatorAlphaNumeic implements Comparator<String>, java.io.Serializable {
	...
	public static void main(String... args) {
		...
		java.util.Arrays.sort(strings, new da_StringComparatorAlphaNumeic());
