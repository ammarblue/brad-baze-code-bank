 ...
 * expressed as a fraction of the total bandwidth of the spectrum. The total bandwidth of the spectrum is equal to the Nyquist
...
public abstract class m_a_FourierTransform {
	...
	m_a_FourierTransform (int ts, float sr) {
		timeSize = ts;
		sampleRate = (int)sr;
