 ...
 * palette.
 */
public class vc_ColorTheoryStrategyMonochrome implements vc_i_ColorTheoryStrategy {
     ...
     */
    public vc_ColorList createListFromColor(z_Colors src) {
        vc_ColorList colors = new vc_ColorList(src);
        z_Colors c = src.copy();
        ...
        c = src.copy();
        c.setBrightness(m_MathUtils.max(0.2f,
