...
public class m_RangeFloatBiased extends m_RangeFloat {
     ...
     */
    public m_RangeFloatBiased(float min, float max, float bias, float sd) {
        super(min, max);
        setBias(bias);
        setStandardDeviation(sd);
    }

    public m_RangeFloatBiased copy() {
        m_RangeFloatBiased r = new m_RangeFloatBiased(min, max, bias,
                standardDeviation * 2);
