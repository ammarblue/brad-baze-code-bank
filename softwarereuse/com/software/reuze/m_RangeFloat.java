...
public class m_RangeFloat {

    public static m_RangeFloat fromSamples(float... samples) {
        ...
        return new m_RangeFloat(min, max);
    }

    public static m_RangeFloat fromSamples(List<Float> samples) {
        float min = Float.MAX_VALUE;
        float max = Float.MIN_VALUE;
        for (float s : samples) {
            min = m_MathUtils.min(min, s);
    ...
    public m_RangeFloat(float min, float max) {
        // swap if necessary...
        if (min > max) {
            float t = max;
            max = min;
    ...
    public m_RangeFloat copy() {
        m_RangeFloat range = new m_RangeFloat(min, max);
    ...
    public m_RangeFloat seed(long seed) {
        random.setSeed(seed);
        return this;
    }
    ...
    public m_RangeFloat setRandom(Random rnd) {
        random = rnd;
        return this;
    }
