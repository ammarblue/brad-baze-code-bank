 ...
 * @author Nathan Sweet */
abstract public class d_Pool<T> { /*RPC0812*/
	public final int max;

	private final d_Array<T> freeObjects;
	...
	public d_Pool (int initialCapacity) {
		this(initialCapacity, Integer.MAX_VALUE);
	}

	/** @param max The maximum number of free objects to store in this pool. */
	public d_Pool (int initialCapacity, int max) {
		freeObjects = new d_Array(false, initialCapacity);
		this.max = max;
	}
	 ...
	 * @see #free(Object) */
	public void free (d_Array<T> objects) {
