 ...
 * </p>
 */
public class m_WaveFMHarmonicSquare extends m_a_Wave {
    ...
    public m_WaveFMHarmonicSquare(float phase, float freq, m_a_Wave fmod) {
        super(phase, freq);
        this.fmod = fmod;
    }
     ...
     * @param offset
     */
    public m_WaveFMHarmonicSquare(float phase, float freq, float amp, float offset) {
        this(phase, freq, amp, offset, new m_WaveConstant(0));
    }

    public m_WaveFMHarmonicSquare(float phase, float freq, float amp,
            float offset, m_a_Wave fmod) {
     ...
     * 
     * @see m_a_Wave.math.waves.WaveAbstract#reset()
     */
    public void reset() {
        super.reset();
        fmod.reset();
     ...
     * 
     * @see m_a_Wave.math.waves.WaveAbstract#update()
     */
    public float update() {
        value = 0;
