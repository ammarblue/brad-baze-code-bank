...
public final class BitArrayTest extends TestCase {
  ...
  public void testGetSet() {
    d_ArrayBits array = new d_ArrayBits(33);
    for (int i = 0; i < 33; i++) {
  ...
  public void testGetNextSet1() {
    d_ArrayBits array = new d_ArrayBits(32);
    for (int i = 0; i < array.getSize(); i++) {
      assertEquals(String.valueOf(i), 32, array.getNextSet(i));
    }
    array = new d_ArrayBits(33);
    for (int i = 0; i < array.getSize(); i++) {
  ...
  public void testGetNextSet3() {
    d_ArrayBits array = new d_ArrayBits(63);    
    array.set(31);
    array.set(32);
    for (int i = 0; i < array.getSize(); i++) {
      int expected;
  ...
  public void testGetNextSet5() {
    ...
    for (int i = 0; i < 10; i++) {
      d_ArrayBits array = new d_ArrayBits(1 + r.nextInt(100));
  ...
  public void testSetBulk() {
    d_ArrayBits array = new d_ArrayBits(64);
