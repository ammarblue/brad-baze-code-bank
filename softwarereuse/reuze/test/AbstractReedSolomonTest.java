 ...
 * @author Sean Owen
 */
abstract class AbstractReedSolomonTest extends Assert {
  ...
  static void doTestQRCodeEncoding(int[] dataBytes, int[] expectedECBytes) {
    ...
    new c_ReedSolomonEncoder(m_GaloisFieldOps.QR_CODE_FIELD_256).encode(toEncode, expectedECBytes.length);
