...
import com.software.reuze.c_ReedSolomonDecoder;
import com.software.reuze.l_ExceptionCodeReedSolomon;
import com.software.reuze.m_GaloisFieldOps;

import reuze.test.AbstractReedSolomonTest;
 ...
 */
public final class ReedSolomonDecoderDataMatrixTest extends AbstractReedSolomonTest {
  ...
  private final c_ReedSolomonDecoder dmRSDecoder = new c_ReedSolomonDecoder(m_GaloisFieldOps.DATA_MATRIX_FIELD_256);

  @Test
  public void testNoError() throws l_ExceptionCodeReedSolomon {
  ...
  @Test
  public void testOneError() throws l_ExceptionCodeReedSolomon {
    int[] received = new int[DM_CODE_TEST_WITH_EC.length];
  ...
  @Test
  public void testMaxErrors() throws l_ExceptionCodeReedSolomon {
    int[] received = new int[DM_CODE_TEST_WITH_EC.length];
    Random random = getRandom();
  ...
  public void testTooManyErrors() {
    ...
    } catch (l_ExceptionCodeReedSolomon rse) {
      // good
    }
  }

  private void checkQRRSDecode(int[] received) throws l_ExceptionCodeReedSolomon {
