 ...
 */
public final class BitMatrixTest extends TestCase {

  @Test
  public void testGetSet() {
    d_MatrixBits matrix = new d_MatrixBits(33);
  ...
  public void testSetRegion() {
    d_MatrixBits matrix = new d_MatrixBits(5);
  ...
  public void testRectangularMatrix() {
    d_MatrixBits matrix = new d_MatrixBits(75, 20);
  ...
  public void testRectangularSetRegion() {
    d_MatrixBits matrix = new d_MatrixBits(320, 240);
  ...
  public void testGetRow() {
    d_MatrixBits matrix = new d_MatrixBits(102, 5);
    for (int x = 0; x < 102; x++) {
      if ((x & 0x03) == 0) {
        matrix.set(x, 2);
      }
