 ...
 * @author Sean Owen
 */
public final class ReedSolomonEncoderQRCodeTest extends AbstractReedSolomonTest {
  ...
  public void testQRCodeVersusDecoder() throws Exception {
    ...
    c_ReedSolomonEncoder encoder = new c_ReedSolomonEncoder(m_GaloisFieldOps.QR_CODE_FIELD_256);
    c_ReedSolomonDecoder decoder = new c_ReedSolomonDecoder(m_GaloisFieldOps.QR_CODE_FIELD_256);
    for (int i = 0; i < 100; i++) {
