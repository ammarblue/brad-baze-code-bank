...
@RunWith(Suite.class)
@Suite.SuiteClasses( { 
	    GibbsAskTest.class, LikelihoodWeightingTest.class,
		ParticleFilterTest.class, PriorSampleTest.class,
		RejectionSamplingTest.class,
	    EliminationAskTest.class, EnumerationAskTest.class,
	    CPTTest.class, 
	    FiniteBayesModelTest.class,
		FullJointProbabilityModelTest.class, 
		FixedLagSmoothingTest.class,
		HMMForwardBackwardConstantSpaceTest.class,
		HMMForwardBackwardTest.class, 
		MarkovDecisionProcessTest.class,
		PolicyIterationTest.class, ValueIterationTest.class,
		ForwardBackwardTest.class, ProbUtilTest.class,
		ProbabilityTableTest.class })
public class AllProbabilityTest {
