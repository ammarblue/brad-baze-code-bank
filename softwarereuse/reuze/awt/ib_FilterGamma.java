 ...
 */
public class ib_FilterGamma extends ib_a_FilterTransfer {

	private float rGamma, gGamma, bGamma;

	public ib_FilterGamma() {
		this(1.0f);
	}

	public ib_FilterGamma(float gamma) {
		this(gamma, gamma, gamma);
	}

	public ib_FilterGamma(float rGamma, float gGamma, float bGamma) {
