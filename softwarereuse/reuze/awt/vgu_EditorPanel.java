...
import com.software.reuze.dg_ParticleEmitter.ParticleValue;



public class vgu_EditorPanel extends JPanel {
	private final String name;
	private final dg_ParticleEmitter.ParticleValue value;
	...
	public vgu_EditorPanel (String name, dg_ParticleEmitter.ParticleValue value) {
		this.name = name;
		this.value = value;
