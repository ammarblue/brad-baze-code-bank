...
import com.software.reuze.dg_ParticleEmitter.RangedNumericValue;


public class vgu_RangedNumericPanel extends vgu_EditorPanel {
	private final dg_ParticleEmitter.RangedNumericValue value;
	JSpinner minSpinner, maxSpinner;
	JButton rangeButton;
	JLabel label;

	public vgu_RangedNumericPanel (String name, final dg_ParticleEmitter.RangedNumericValue value) {
		super(name, value);
		this.value = value;
