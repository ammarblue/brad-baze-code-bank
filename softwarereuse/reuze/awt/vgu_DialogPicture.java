 ...
 */
public final class vgu_DialogPicture implements ActionListener {
   ...
   /**
     ...
     */
    public vgu_DialogPicture(int w, int h) {
        width = w;
        height = h;
   ...
   /**
     ...
     */
    public vgu_DialogPicture(String filename) {
   ...
   /**
     ...
     */
    public vgu_DialogPicture(File file) {
   ...
   /**
    ...
    public static void main(String[] args) {
        vgu_DialogPicture pic = new vgu_DialogPicture(args[0]);
