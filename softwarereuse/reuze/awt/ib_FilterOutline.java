...
import com.software.reuze.ib_a_FilterBinary;
 ...
 */
public class ib_FilterOutline extends ib_a_FilterBinary {

	public ib_FilterOutline() {
		newColor = 0xffffffff;
	}
	public ib_FilterOutline(int color) {
		newColor = color;
	}
