...
/**
 * A filter which performs reduces noise by looking at each pixel's 8 neighbors, and if it's a minimum or maximum,
 * replacing it by the next minimum or maximum of the neighbors.
 */
public class ib_FilterNoiseReduction extends ib_a_FilterWholeImage {

	public ib_FilterNoiseReduction() {
	}
