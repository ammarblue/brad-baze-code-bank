...
import com.software.reuze.dg_ParticleEmitter.SpawnEllipseSide;
import com.software.reuze.dg_ParticleEmitter.SpawnShape;
import com.software.reuze.dg_ParticleEmitter.SpawnShapeValue;


public class vgu_SpawnPanel extends vgu_EditorPanel {
	...
	public vgu_SpawnPanel (final dg_ParticleEmitter.SpawnShapeValue spawnShapeValue, final appParticleEditor editor) {
		super("Spawn", null);
		...
		shapeCombo.addActionListener(new ActionListener() {
			public void actionPerformed (ActionEvent event) {
				dg_ParticleEmitter.SpawnShape shape = (dg_ParticleEmitter.SpawnShape)shapeCombo.getSelectedItem();
		...
		sideCombo.addActionListener(new ActionListener() {
			public void actionPerformed (ActionEvent event) {
				dg_ParticleEmitter.SpawnEllipseSide side = (dg_ParticleEmitter.SpawnEllipseSide)sideCombo.getSelectedItem();
	...
	public void update (appParticleEditor editor) {
	...
	private void initializeComponents () {
		...
		}
		{
			...
			shapeCombo.setModel(new DefaultComboBoxModel(dg_ParticleEmitter.SpawnShape.values()));
		...
		}
		{
			...
			sideCombo.setModel(new DefaultComboBoxModel(dg_ParticleEmitter.SpawnEllipseSide.values()));
