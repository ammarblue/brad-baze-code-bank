...
import com.software.reuze.ff_i_MIDIDrumMap;
import com.software.reuze.ff_i_MIDIProgramChanges;
import com.software.reuze.s_SoundCipherUtilities;
import com.software.reuze.s_i_PitchClassSets;
 ...
 * The {@link s_SoundCipherScore} class is used to provide musical data structure and timing of events.
 * <br>
...
public class s_SoundCipher extends s_SoundCipherUtilities implements ff_i_MIDIProgramChanges, ff_i_MIDIDrumMap, s_i_PitchClassSets, ff_MIDIMessageTypes {
    /** Creates an instance of the SCScore class for use behind the scenes */
    public s_SoundCipherScore score = new s_SoundCipherScore();
    ...
    /** Specifies the default pan position to be 64, in the centre [0 - 127] */
    public double pan = 64;
    /** Specifies the default number of repeats for score playback [-1 = infinite] */
 ...
 /**
    ...
    //****************************
    /**
     * Report the available MIDI devices. Prints the list of devices and id info to the console.
     *
	...
	*/
	...
	try {
	    InputStream is = z_Processing.app.createInput(fileName);
    ...
    /**
     * Transmit a MIDI message immediately.
     *
	...
	try {
	     is = z_Processing.app.createInput(fileName);
	...
	try {
	    clip = java.applet.Applet.newAudioClip(new java.net.URL ("file://" + z_Processing.app.dataPath(fileLocation)));
	} catch (Exception e) {
	    e.printStackTrace();
	}
	return clip;
     ...
     *
     * @param clip The audio clip object loaded by loadAudioClip()
     */
    ...
    /**
     * Repeat indefinitely the specified audio clip. Use stopAudioClip() to halt playback.
     *
