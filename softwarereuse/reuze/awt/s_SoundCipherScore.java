 ...
 * of the {@link s_SoundCipher} library for 
 ...
 * arbitrary synchronised purpose (e.g. audio file playback, drawing, 
 ...
 */
public class s_SoundCipherScore extends s_SoundCipherUtilities implements MetaEventListener,
        ff_i_MIDIProgramChanges, ff_i_MIDIDrumMap, s_i_PitchClassSets, ff_MIDIMessageTypes {
    ...
    /** The number of MIDI pulses per quarter note */
    ...
    /** Specifies the default pan position to be 64, in the center [0 - 127] */
     ...
     * @param newPos The value to set the pan position to, from 0 - 127.
     */
    ...
    /**
     * Specify the top number of the time signature for this score.
    ...
    /**
     * Specify the lower number of the time signature for this score.
     * @param value The value for the denominator, whole number greater than 0.
     */
    ...
    public void meta(MetaMessage message) {
        ...
        if (message.getType() == 70) {
            if (z_Processing.isound != null) {
                try {
                            z_Processing.isound.handleCallbacks((message.getData())[0]);
    ...
    public void addCallbackListener(s_i_SoundCallback sis) {
    	z_Processing.isound=sis;
    }
