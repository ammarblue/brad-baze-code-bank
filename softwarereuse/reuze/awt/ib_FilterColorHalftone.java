 ...
 */
 public class ib_FilterColorHalftone extends ib_a_Ops {
        ...
        for ( int y = 0; y < height; y++ ) {
            ...
            for ( int channel = 0; channel < 3; channel++ ) {
                ...
                for ( int x = 0; x < width; x++ ) {
                    ...
                    tx = tx-m_MathUtils.mod( tx-halfGridSize, gridSize )+halfGridSize;
                    ty = ty-m_MathUtils.mod( ty-halfGridSize, gridSize )+halfGridSize;
                    ...
                    for ( int i = 0; i < 5; i++ ) {
                        ...
                        // Clamp to the image
                        int nx = m_MathUtils.clamp( (int)ntx, 0, width-1 );
                        int ny = m_MathUtils.clamp( (int)nty, 0, height-1 );
                        ...
                        float f2 = 1-m_MathUtils.smoothStep( R, R+1, l );
                        f = Math.min( f, f2 );
                    }
