...
import com.software.reuze.dg_ParticleEmitter.GradientColorValue;


public class vgu_GradientPanel extends vgu_EditorPanel {
	private final dg_ParticleEmitter.GradientColorValue value;
	private GradientEditor gradientEditor;
	ColorSlider saturationSlider, lightnessSlider;
	JPanel colorPanel;
	private ColorSlider hueSlider;

	public vgu_GradientPanel (String name, dg_ParticleEmitter.GradientColorValue value) {
		super(name, value);
		this.value = value;
		...
		JPanel contentPanel = getContentPanel();
		{
			gradientEditor = new GradientEditor() {
				public void handleSelected (Color color) {
					vgu_GradientPanel.this.setColor(color);
				}
			};
