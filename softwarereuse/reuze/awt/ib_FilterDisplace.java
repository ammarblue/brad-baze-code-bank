 ...
 */
public class ib_FilterDisplace extends ib_a_FilterTransform {

	private float amount = 1;
	private z_BufferedImage displacementMap = null;
	private int[] xmap, ymap;
	private int dw, dh;

	public ib_FilterDisplace() {
	}
	
	public void setDisplacementMap(z_BufferedImage displacementMap) {
		this.displacementMap = displacementMap;
	}

	public z_BufferedImage getDisplacementMap() {
    ...
    public z_BufferedImage filter( z_BufferedImage src, z_BufferedImage dst ) {
		...
		z_BufferedImage dm = displacementMap != null ? displacementMap : src;
