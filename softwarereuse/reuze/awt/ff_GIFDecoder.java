...
public class ff_GIFDecoder {
	...
	protected z_BufferedImage image; // current frame
	...
	static class GifFrame {
		public GifFrame(z_BufferedImage im, int del) {
			image = im;
			delay = del;
		}

		public z_BufferedImage image;
	 ...
	 */
	public z_BufferedImage getFrame(int n) {
		z_BufferedImage im = null;
		if ((n >= 0) && (n < frameCount)) {
	...
	protected void readImage() {
		...
		image = new z_BufferedImage(width, height, BufferedImage.TYPE_INT_ARGB_PRE);
