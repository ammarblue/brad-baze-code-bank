 ...
 */
public class ib_FilterNoise extends ib_a_FilterPoint {
	...
	public int filterRGB(int x, int y, int rgb) {
		if ( randomNumbers.nextFloat() <= density ) {
			...
			if (monochrome) {
				...
				r = m_MathUtils.clampToByte(r+n);
				g = m_MathUtils.clampToByte(g+n);
				b = m_MathUtils.clampToByte(b+n);
			} else {
				r = random(r);
				g = random(g);
				b = random(b);
