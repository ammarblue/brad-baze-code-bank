...
public class vgu_PercentagePanel extends vgu_EditorPanel {
	final dg_ParticleEmitter.ScaledNumericValue value;
	JButton expandButton;
	vgu_ChartAWT chart;

	public vgu_PercentagePanel (String name, String chartTitle, final dg_ParticleEmitter.ScaledNumericValue value) {
		super(name, value);
		this.value = value;
