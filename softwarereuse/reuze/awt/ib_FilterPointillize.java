...
public class ib_FilterPointillize extends ib_FilterCellular {
	...
	public int getPixel(int x, int y, int[] inPixels, int width, int height) {
		...
		if (fadeEdges) {
			...
			v = i_MathImageUtils.mixColors(0.5f*f1/f2, v, v2);
		} else {
			f = 1-m_MathUtils.smoothStep(edgeThickness, edgeThickness+fuzziness, f1);
