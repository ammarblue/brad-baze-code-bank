 ...
 */
public final class vgu_StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static vgu_StdDraw std = new vgu_StdDraw();
    ...
    *************************************************************************/
    ...
    public static void line(double x0, double y0, double x1, double y1) {
        offscreen.draw(new java.awt.geom.Line2D.Double(scaleX(x0), scaleY(y0), scaleX(x1), scaleY(y1)));
        draw();
    }
    ...
    *************************************************************************/
    ...
    private static Image getImage(String filename) {
        ...
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
            URL url = vgu_StdDraw.class.getResource(filename);
    ...
    *************************************************************************/
    ...
    public void actionPerformed(ActionEvent e) {
        FileDialog chooser = new FileDialog(vgu_StdDraw.frame, "Use a .png or .jpg extension", FileDialog.SAVE);
        chooser.setVisible(true);
        String filename = chooser.getFile();
        if (filename != null) {
            vgu_StdDraw.save(chooser.getDirectory() + File.separator + chooser.getFile());
        }
    }
    ...
    *************************************************************************/
    ...
    public void mousePressed(MouseEvent e) {
        synchronized (mouseLock) {
            mouseX = vgu_StdDraw.userX(e.getX());
            mouseY = vgu_StdDraw.userY(e.getY());
            mousePressed = true;
        }
    }
    ...
    *************************************************************************/
    ...
    public static void main(String[] args) {
        vgu_StdDraw.square(.2, .8, .1);
        vgu_StdDraw.filledSquare(.8, .8, .2);
        vgu_StdDraw.circle(.8, .2, .2);

        vgu_StdDraw.setPenColor(vgu_StdDraw.BOOK_RED);
        vgu_StdDraw.setPenRadius(.02);
        vgu_StdDraw.arc(.8, .2, .1, 200, 45);

        // draw a blue diamond
        vgu_StdDraw.setPenRadius();
        vgu_StdDraw.setPenColor(vgu_StdDraw.BOOK_BLUE);
        double[] x = { .1, .2, .3, .2 };
        double[] y = { .2, .3, .2, .1 };
        vgu_StdDraw.filledPolygon(x, y);

        // text
        vgu_StdDraw.setPenColor(vgu_StdDraw.BLACK);
        vgu_StdDraw.text(0.2, 0.5, "black text");
        vgu_StdDraw.setPenColor(vgu_StdDraw.WHITE);
        vgu_StdDraw.text(0.8, 0.8, "white text");
    }
