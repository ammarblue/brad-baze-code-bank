...
public class ib_FilterOffset extends ib_a_FilterTransform implements java.io.Serializable {

	private int width, height;
	private int xOffset, yOffset;
	private boolean wrap;

	public ib_FilterOffset() {
		this(0, 0, true);
	}

	public ib_FilterOffset(int xOffset, int yOffset, boolean wrap) {
