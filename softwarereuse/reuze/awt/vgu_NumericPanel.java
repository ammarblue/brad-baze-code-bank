...
public class vgu_NumericPanel extends vgu_EditorPanel {
	private final dg_ParticleEmitter.NumericValue value;
	JSpinner valueSpinner;

	public vgu_NumericPanel (String name, final dg_ParticleEmitter.NumericValue value) {
		super(name, value);
		this.value = value;
