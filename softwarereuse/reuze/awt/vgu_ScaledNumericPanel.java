...
import com.software.reuze.dg_ParticleEmitter.ScaledNumericValue;


public class vgu_ScaledNumericPanel extends vgu_EditorPanel {
	final dg_ParticleEmitter.ScaledNumericValue value;
	...
	public vgu_ScaledNumericPanel (String name, String chartTitle, final dg_ParticleEmitter.ScaledNumericValue value) {
		super(name, value);
		this.value = value;
	...
	private void initializeComponents (String chartTitle) {
		...
		{
			chart = new vgu_ChartAWT(chartTitle) {
