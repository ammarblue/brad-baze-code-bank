...
public class ib_FilterQuilt extends ib_a_FilterWholeImage implements java.io.Serializable {
	...
	protected int[] filterPixels( int width, int height, int[] inPixels, ga_Rectangle transformedSpace ) {
		...
		for (int n = 0; n < 20; n++) {
			float mx = m_MathUtils.PI*x;
			float my = m_MathUtils.PI*y;
