...
public class ff_PNGencoder extends Object {
     ...
     * @see java.awt.Image
     */
    public ff_PNGencoder(Image image) {
     ...
     * @see java.awt.Image
     */
    public ff_PNGencoder(Image image, boolean encodeAlpha) {
     ...
     * @see java.awt.Image
     */
    public ff_PNGencoder(Image image, boolean encodeAlpha, int whichFilter) {
     ...
     * @see java.awt.Image
     */
    public ff_PNGencoder(Image image, boolean encodeAlpha, int whichFilter, int compLevel) {
        this.image = image;
