 ...
 * @author Keith
 */
public class demoGameShooterApplet extends demoGameShooterMain{
	AppletImpl applet;
	public demoGameShooterApplet(AppletImpl applet){
		this.applet = applet;
	}
	...
	public void start(){
		Thread t = new Thread(){
			public void run(){
				...
				demoGameShooterMain main = demoGameShooterApplet.this;
				viewPane = new ViewPaneShooter(main);
				System.out.println(this.getClass().getSimpleName()+": start .1");
				applet.add(viewPane);
