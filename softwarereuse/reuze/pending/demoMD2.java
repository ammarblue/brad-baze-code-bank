...
public class demoMD2 extends PApplet {
...
public void setup() {
  ...
  //model1 = loader.loadModel("./data/ogro/ogro.md2", "./data/ogro/ogrobase.jpg");
  model1 = loader.loadModel("./data/homer/homer.md2", "./data/homer/wrestler.png");
  model2 = loader.loadModel("./data/ogro/weapon.md2", "./data/ogro/weapon.jpg");

  loader = null; // loader no longer required so get rid of it to release RAM

  G4P.setTextMode(SCREEN); 
  G4P.messagesEnabled(false);

  // Sets the color scheme for the GUI components 
