...
import com.software.reuze.dasg_SearchAdversarialIterativeDeepeningAlphaBeta;
import com.software.reuze.dasg_SearchAdversarialMinimax;
 ...
 */
//TODO doesn't check blocking red's winning moves, examines millions of other choices
public class demoConnectFour {
	...
	public static void main(String[] args) {
		JFrame frame = new demoConnectFour().constructApplicationFrame();
	...
	private static class ConnectFourPanel extends JPanel implements
		...
		private void proposeMove() {
			...
			case 1:
				...
				break;
			case 2:
				search = dasg_SearchAdversarialIterativeDeepeningAlphaBeta.createFor(game, 0.0,
						1.0, time);
				break;
			case 3:
