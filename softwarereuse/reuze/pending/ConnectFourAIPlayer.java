...
public class ConnectFourAIPlayer extends
		dasg_SearchAdversarialIterativeDeepeningAlphaBeta<ConnectFourState, Integer, String> {

	public ConnectFourAIPlayer(dg_i_Game<ConnectFourState, Integer, String> game,
			int time) {
