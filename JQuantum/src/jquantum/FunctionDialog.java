/*
 * FunctionDialog.java - Dialog class of the jQuantum computer simulator
 *
...
/**
 * This class enables to input of an arbitrary function for function evaluation
 * to be added to a quantum circuit.
 * 
...
public class FunctionDialog extends javax.swing.JDialog {
	...
	public FunctionDialog(java.awt.Frame parent, boolean modal,
			Properties bundle) {
		super(parent, modal);
		this.bundle = bundle;
		...
		questionLabel.setText(bundle
				.getProperty("FunctionDialog.questionLabel.text"));
	...
	private void setValues() {
		...
		try {
			...
			if (!FunctionParser.checkSyntax(input))
				throw new IllegalArgumentException("Function syntax wrong: "
						+ input);
	...
	private String showOperators(int n) {
		if (FunctionParser.operator.length <= n)
			return "";
		String output = "";
	 ...
	 * (Exception e2) { e2.printStackTrace(); } } new FunctionDialog(new
