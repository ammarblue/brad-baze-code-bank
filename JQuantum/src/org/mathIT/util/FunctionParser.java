 ...
 * functions. The letters <i>x</i>, <i>y</i>, and <i>z</i> are reserved as
 * variables, the infix operators +, -, *, /, %, ^, and mod are understood, as
 * well as logical operators such as ==, <=, >=, "and", "or", "xor", &&, |, but
 * <i>not</i> || (note that &, | are interpreted as logical operators, not as
 * binary ones, and that = is equivalent to ==). The usual mathematical
 * functions are also interpreted, besides the Riemann-Siegel Z-function. A
 * complete list of possible operators are determined in the array
 * {@link #operator} and can be displayed by implementing the following snippet:
 * 
 * <pre>
 * String[] text = { &quot;Variables&quot;, &quot;Functions&quot;, &quot;Binary Infix Operators&quot;,
 * 		&quot;Ternary Operators&quot; };
 ...
 * </pre>
 * 
 * Fractional numbers (i.e., <code>double</code> values) have to be inputted
...
public class FunctionParser implements java.io.Serializable {
	...
	/**
	 * Table of predefined operators. In the <i>i</i>-throw row there are
	 * <i>i</i>-nary operators, variables are counted as nullary operators.
	 ...
	 * 		&quot;x&quot;, &quot;y&quot;, &quot;z&quot; },
	 * 		{// unary operators:
	 * 		&quot;ln&quot;, &quot;ld&quot;, &quot;exp&quot;, &quot;log&quot;, &quot;sqrt&quot;, &quot;w&quot;, &quot;sin&quot;, &quot;cos&quot;, &quot;tan&quot;, &quot;cot&quot;,
	 * 				&quot;sec&quot;, &quot;csc&quot;, &quot;asin&quot;, &quot;acos&quot;, &quot;atan&quot;, &quot;acot&quot;, &quot;sinh&quot;, &quot;cosh&quot;,
	 * 				&quot;tanh&quot;, &quot;coth&quot;, &quot;arsinh&quot;, &quot;arcosh&quot;, &quot;artanh&quot;, &quot;arcoth&quot;, &quot;Z&quot; },
	 * 		{// binary operators:
	 * 		&quot;+&quot;, &quot;-&quot;, &quot;*&quot;, &quot;/&quot;, &quot;%&quot;, &quot;&circ;&quot;, &quot;mod&quot;, &quot;=&quot;, &quot;&lt;&quot;, &quot;&gt;&quot;, &quot;==&quot;, &quot;&lt;=&quot;, &quot;&gt;=&quot;,
	 * 				&quot;&amp;&amp;&quot;, &quot;|&quot;, &quot;&amp;&quot;, &quot;and&quot;, &quot;or&quot;, &quot;xor&quot;, &quot;;&quot;, &quot;,&quot; }, {// ternary
	 * 																	// operators:
	 ...
	 * </pre>
	 */
	public static final String[][] operator = { {// variables:
			"x", "y", "z" }, {// unary operators:
			"ln", "ld", "exp", "log", "sqrt", "w", "sin", "cos", "tan", "cot",
					"sec", "csc", "asin", "acos", "atan", "acot", "sinh",
					"cosh", "tanh", "coth", "arsinh", "arcosh", "artanh",
					"arcoth", "Z" }, {// binary operators:
			"+", "-", "*", "/", "%", "^", "mod", "=", "<", ">", "==", "<=",
					">=", "&&", "|", "&", "and", "or", "xor", ";", "," }, {// ternary
																			// operators:
			"if", "modPow" },
	/*
	 * {// quaternary operators: "for", "sum" }
	 */
	};
	...
	/**
	 * Creates a function parser from a single function in usual notation, infix
	 * for binary operators and prefix for functions and ternary operators. The
	 * letters <i>x</i>, <i>y</i>, and <i>z</i> are reserved as variables, the
	 * infix operators +, -, *, /, %, ^, and mod are possible, as well as
	 * logical operators such as ==, <=, >=, "and", "or", "xor", &&, |, but
	 * <i>not</i> || (note that &, | are interpreted as logical operators, not
	 * as binary ones, and that = is equivalent to ==). The usual mathematical
	 * functions are also interpreted, besides the Riemann-Siegel Z-function. A
	 * complete list of possible operators are determined in the array
	 * {@link #operator} and can be displayed by implementing the following
	 * snippet:
	 * 
	 * <pre>
	 * String[] text = { &quot;Variables&quot;, &quot;Functions&quot;, &quot;Binary Infix Operators&quot;,
	 ...
	 * 
	 * @param function
	 *            a string of the function in usual notation
	 */
	...
	/**
	 * Creates a function parser from a list of functions in usual (infix or
	 * prefix) notation. See {@link #FunctionParser(String)} for detailed
	 * description of the requirements of the input strings.
	 * 
	 * @param functionList
	 *            an array of strings of functions in usual notation
	 */
	 ...
	 * 
	 * @param functions
	 *            a list of functions in parsed postfix notation
	 */
	...
	/**
	 * Analyses and parses the function being input as a string. First the
	 * string is divided in its operators and operands, then its syntax is
	 * checked. Only operators, integers or real numbers are admissible.
	 * 
	 * @param function
	...
	private static String[] analyse(String function) {
		...
		for (int i = 0; i < constantName.length; i++) {
			function = function.replaceAll(constantName[i],
					Double.toString(constantValue[i]));
		}
		...
		while (i < function.length()) {
			...
			if (isDigit(symbol)) {
				...
				int opLength = 1;
				boolean isOp = false;
				while (!isOp && (i + opLength <= function.length())
			...
			// "-" may be a prefix operator, but only after "(", boolean
			// operators,
			// comparison operators, or as the first element. Other
			// constellations
			// cause an error.
			...
			if (j > 3 && element.get(j - 1).equals("mod")
					&& element.get(j - 3).equals("^")) {
				/*
				 * --- if ( j > 3 && element.get(j-1).equals("mod") ) { // Find
				 * index of the next operand: int index = j - 1; int i2 = index;
				 * boolean firstArgument = true; // 1st argument an operator?
				 * while (i2 > 0 && firstArgument) { index -=
				 * getArity(element.get(i2)); firstArgument =
				 * (getArity(element.get(i2)) > 0 ) ? true : false; i2--;
				 * System.out.println("+++++ i2="+ i2 + ", element[i2]=" +
				 * element.get(i2) + " " + firstArgument); } if
				 * (element.get(index).equals("^")) { // ------
				 */
	...
	/**
	 * Tests whether the argument <code>string</code> is a number or a variable
	 * of the operator list.
	 * 
	 * @param num
	 *            a string representing a number, a variable, or an operator
	...
	/**
	 * Tests whether the argument <code>string</code> is an i-nary operator. i=0
	 * is a variable, i=1 a unary operator, i=2 a binary operator, i=3 a ternary
	 * operator, etc.
	 */
	 ...
	 * number or a variable, 1 if it is unary (i.e., a function), 2 if it is
	 * binary, 3 if it is ternary, ...
	 * 
	 * @param name
	...
	private static int getArity(String name) {
		for (int i = operator.length - 1; i >= 0; i--) {
			for (int j = 0; j < operator[i].length; j++) {
				if (name.equalsIgnoreCase(operator[i][j]))
					return i;
			}
		}
	...
	private static boolean isDigit(String symbol) {
		return (symbol.equals("1") || symbol.equals("2") || symbol.equals("3")
				|| symbol.equals("4") || symbol.equals("5")
				|| symbol.equals("6") || symbol.equals("7")
				|| symbol.equals("8") || symbol.equals("9")
				|| symbol.equals("0") || symbol.equals("."));
	}

	/**
	 * checks if operator op1 has the same or a higher priority than operator
	 * op2.
	 */
	private boolean priority(String op1, String op2) {
		...
		// System.out.println("## prio(" + op1 + ") >= prio(" + op2 + ") ? " + (
		// prioOP[0] >= prioOP[1] ) );
		return (prioOP[0] >= prioOP[1]);
	}

	/**
	 * Returns an array of the parts of the <i>i</i>-th function in postfix
	 * notation.
	 * 
	 * @param i
	 *            specifies the index of the function
	 ...
	 * usual notation. "Usual notation" here means, that the string contains
	 * infix notation for binary operators, such as <code>((2*x) + 2)</code>,
	 * and prefix notation for functions and ternary operators, e.g.,
	 * <code>sin(x)</code> or <code>if(-1 < x && x < 1; 1; 0)</code>.
	 * 
	 * @param i
	 *            the index of the function to be returned
	 * @param postfix
	 *            specifies whether the returned string is in postfix notation
	 * @return a string representing the function, either in usual
	 *         (infix/prefix) or in postfix notation
	 */
	 ...
	 * 
	 * @param postfix
	 *            the function in postfix notation
		...
		if (arity <= 0) { // name represents a number or a variable
			...
			if (isNumber(postfix[postfix.length - 2])) {
				...
				while (i > 0 && firstArgument) {
					...
					i--;
					// System.out.println("+++++ i="+ i + ", postfix[i]=" +
					// postfix[i] + " " + firstArgument);
				}
				...
				// int index = postfix.length - getArity(postfix[postfix.length
				// - 2]) - 2;
				...
				/*
				 * // System.out.print("### part1 = ["); for(String s : part1) {
				 * System.out.print(s+", "); } System.out.println("]");
				 * System.out.print("### part2 = ["); for(String s : part2) {
				 * System.out.print(s+", "); } System.out.println("]");
				 * 
				 * System.out.println("+++ part1: ["+ index + ", " + (index +
				 * part1.length - 1) + "]"); System.out.println("+++ part2: ["+
				 * 0 + ", " + (part2.length - 1) + "]"); //
				 */
			}
			// use infix notation:
			return "(" + postfix2String(part2) + " " + name + " "
					+ postfix2String(part1) + ")";
			...
			while (i > 0 && firstArgument) {
				...
				firstArgument = (getArity(postfix[i]) > 0) ? true : false;
				i--;
				// System.out.println("+++ 1) i="+ i + ", postfix[i]=" +
				// postfix[i] + " " + firstArgument);
			}
			...
			while (i > 0 && secondArgument) {
				...
				secondArgument = (getArity(postfix[i]) > 0) ? true : false;
				i--;
				// System.out.println("+++ 2) i="+ i + ", postfix[i]=" +
				// postfix[i] + " " + secondArgument);
			}
			...
			while (i > 0 && thirdArgument) {
				...
				i--;
				// System.out.println("+++ 3) i="+ i + ", postfix[i]=" +
				// postfix[i] + " " + thirdArgument);
			}
			// System.out.println("+++ name="+ name + ", index = " + index);
			// int index = postfix.length - getArity(postfix[postfix.length -
			// 2]) - 2;
			...
			/*
			 * --- test --- System.out.print("### part1 = ["); for(String s :
			 * part1) { System.out.print(s+", "); } System.out.println("]");
			 * System.out.print("### part2 = ["); for(String s : part2) {
			 * System.out.print(s+", "); } System.out.println("]");
			 * System.out.print("### part3 = ["); for(String s : part3) {
			 * System.out.print(s+", "); } System.out.println("]");
			 * 
			 * //System.out.println("+++ part1: ["+ index + ", " + (index +
			 * part1.length - 1) + "]"); //System.out.println("+++ part2: ["+ 0
			 * + ", " + (part2.length - 1) + "]"); //
			 */
			// use infix notation:
			return postfix2String(part3) + "^" + postfix2String(part2)
					+ " mod " + postfix2String(part1);
		} else {
			String[] part = new String[postfix.length - 1];
			System.arraycopy(postfix, 0, part, 0, part.length);
			return name + "(" + postfix2String(part) + ")";
	...
	/**
	 * Evaluates the <i>i</i>-th function of the current object at the value
	 * <i>x</i>.
	 * 
	 * @param i
	 *            index of the function (starting at 0)
	 * @param x
	 ...
	 *            index of the function (starting at 0)
	 * @param x
	 *            the first parameter value to be inserted
	 * @param y
	 *            the second parameter value to be inserted
	 ...
	 * 
	 * @param x
	 *            the <i>x</i>-value to be inserted
	 * @param z
	 *            the <i>z</i>-value to be inserted
	 ...
	 * 
	 * @param function
	 *            the function in postfix notation, each array element being a
	 *            postfix component
	 * @param x
	...
	private static double evaluatePostFix(String[] function, String[] variable,
			double[] value) {
		if (function == null)
			return Double.NaN;
		...
		for (int i = 0; i < postfix.length; i++) {
			for (int j = 0; j < variable.length; j++) {
				postfix[i] = postfix[i].replaceAll(variable[j],
						Double.toString(value[j]));
			}
		}
		...
		for (int i = 0; i < postfix.length; i++) {
			try {
				...
				System.out.println("Error: Operands of " + postfix[i]
						+ " wrong!");
				e.printStackTrace();
			}
		}
		try {
			...
			System.out
					.println("Error: Operand is no number or function is null!");
			e.printStackTrace();
		}
		return result;
	}
	...
	/**
	 * evaluates the operation determined by the operation op and the operands
	 * x[0] and x[1]. For all operators the operands are pushed from the stack
	 * in reverse order (postfix!), e.g.:
	...
	/** For test purposes... */
	/*
	 * public static void main( String[] args ) { double x = 3; if (args != null
	 * && args.length>0 ) x = Double.parseDouble( args[0] );
	 * 
	 * long startTime = System.currentTimeMillis();
	 * 
	 * String[] fList = {"4^x mod 437", "11^x mod 1147",
	 * "(7+1)^(2*x+2) mod 23"};
	 * 
	 * for ( int i = 0; i < fList.length; i++ ) { boolean ok = checkSyntax(
	 * fList[i] ); System.out.println("Funktion " + i + " ok? " + ok ); }
	 * System.out.println("Running time for checking: " +
	 * (System.currentTimeMillis() - startTime)/1000.0 + " sec" ); startTime =
	 * System.currentTimeMillis();
	 * 
	 * FunctionParser parser = new FunctionParser( fList );
	 * System.out.println("Running time for parsing: " +
	 * (System.currentTimeMillis() - startTime)/1000.0 + " sec" );
	 * 
	 * String funktion; System.out.println("Postfix: -----"); for (int k = 0;
	 * (funktion = parser.getFunction(k,true)) != null; k++) {
	 * System.out.println(funktion); }
	 * 
	 * System.out.println("Infix: ---"); for (int k = 0; (funktion =
	 * parser.getFunction(k,false)) != null; k++) {
	 * System.out.println(funktion); }
	 * 
	 * startTime = System.currentTimeMillis();
	 * 
	 * double y; //y = parser.evaluatePostFix( postfix, x );
	 * //System.out.println("y=" + y);
	 * 
	 * for ( int i = 0; i < fList.length; i++ ) { //String[] postfix =
	 * parser.getFunction(i); //y = parser.evaluatePostFix( postfix, x ); y =
	 * parser.evaluate( i, x ); System.out.println("List: y=" + y); }
	 * System.out.println("Running time for evaluating: " +
	 * (System.currentTimeMillis() - startTime)/1000.0 + " sec" );
	 * 
	 * startTime = System.currentTimeMillis(); for ( int i = 0; i <
	 * fList.length; i++ ) { boolean ok = checkSyntax( fList[i] );
