...
public class mainFrame extends JFrame {
	...
	public static Image map_image = new ImageIcon(
	...
	public mainFrame() {
		...
		displayPanel = new JPanel() {
			...
			public void paintComponent(Graphics g) {
				...
				for (int i = 0; i < year[slider2.getValue()].points.size(); i++) {
					...
					g2d.fillRect(
							(int) (year[slider2.getValue()].points.get(i).x * 5) + 850,
							(int) (year[slider2.getValue()].points.get(i).y * 5),
							2, 2);
				}
		...
		displayPanel.setBounds(10, 10, this.getWidth() - 250,
				this.getHeight() - 200);
	...
	public void paint(Graphics g) {
		super.paint(g);
		Graphics2D g2d = (Graphics2D) g;
		displayPanel.setBounds(10, 10, this.getWidth() - 35,
				this.getHeight() - 200);
		datePanel.setBounds(10, this.getHeight() - 180, this.getWidth() - 35,
				132);
	}
