 ...
 * <p>
 * In practice many messages will contain only a single section.
...
//    private int capacity ;
	...
	//            no factory at that level ...
        ...
        writeable = true ;
        size=0; bufoffset=0; sectionHeader=0; sectionSize=0;
    ...
    public Type getSectionHeader() throws BufferException {
        ...
        int headerStart = ALIGNMENT_UNIT * ((readPtr + (ALIGNMENT_UNIT-1)) / ALIGNMENT_UNIT) ;
                // Round up to multiple of ALIGNMENT_UNIT.
     ...
     * See {@link Buffer class description} for further details.
     ...
     * <tt>source</tt> to the current section of buffer.  
     * See {@link Buffer class description} for details.
     * If the current section of the buffer
    ...
    private void readCheckArgs(int destLen, int dstOff, int numEls)
        ...
        if(numEls > elementsRemaining)
            throw new SectionSizeMismatchException("Trying to read past " +numEls+
                    " end of current section "+elementsRemaining) ;
    }
    ...
    /**
     * Set read-write mode of buffer.
     * Low-level method used for sending and receiving the buffer.
     */
    public void setWritable(boolean yes) {
        writeable = yes ;
    }
}
