...
public class mcBrain extends PApplet {
	mcBrainClass brain;
	PFont font;
	PImage img;
	double[][] input;
	...
	public void draw() {
		...
		text("Error=" + ((int) (error * 10000)) / 10000.0f, -150.0f, 25.0f,
				-300.0f);
		...
		for (int i = 0; i < observations; i += 1) {
			prediction[i].setPosition(input[i][0] * 100,
					predicted_output[i] * 10 + 50, input[i][1] * 100);
			hidden1[i].setPosition(input[i][0] * 100 + 200,
					brain.hiddenValPRES[i][0] * 10 + 50, input[i][1] * 100);
			hidden2[i].setPosition(input[i][0] * 100 + 300,
					brain.hiddenValPRES[i][1] * 10 + 50, input[i][1] * 100);
			hidden3[i].setPosition(input[i][0] * 100 + 400,
					brain.hiddenValPRES[i][2] * 10 + 50, input[i][1] * 100);
			hidden4[i].setPosition(input[i][0] * 100 + 500,
					brain.hiddenValPRES[i][2] * 10 + 50, input[i][1] * 100);
			hidden5[i].setPosition(input[i][0] * 100 + 600,
					brain.hiddenValPRES[i][2] * 10 + 50, input[i][1] * 100);
		}
		...
		for (int i = 0; i < observations - 21; i += 1) {
			if ((i + 1) % 20 != 0) {
				beginShape(QUAD);
				texture(img);
				vertex(+30.0f + (float) input[i][0] * 50.0f,
						(float) input[i][1] * 50.0f,
						(float) predicted_output[i] * 25.0f, 0.0f, 0.0f);
				vertex(+30.0f + (float) input[i + 1][0] * 50.0f,
						(float) input[i + 1][1] * 50.0f,
						(float) predicted_output[i + 1] * 25.0f, 0, 1);
				vertex(+30.0f + (float) input[i + 21][0] * 50.0f,
						(float) input[i + 21][1] * 50.0f,
						(float) predicted_output[i + 21] * 25.0f, 1, 1);
				vertex(+30.0f + (float) input[i + 20][0] * 50.0f,
						(float) input[i + 20][1] * 50.0f,
						(float) predicted_output[i + 20] * 25.0f, 1, 0);
				endShape();
			}
		}
		...
		for (int i = 0; i < observations - 21; i += 1) {
			if ((i + 1) % 20 != 0) {
				...
				texture(img);
				vertex(-30.0f + (float) input[i][0] * 50.0f,
						(float) input[i][1] * 50.0f, (float) output[i] * 25.0f,
						0.0f, 0.0f);
				vertex(-30.0f + (float) input[i + 1][0] * 50.0f,
						(float) input[i + 1][1] * 50.0f,
						(float) output[i + 1] * 25.0f, 0, 1);
				vertex(-30.0f + (float) input[i + 21][0] * 50.0f,
						(float) input[i + 21][1] * 50.0f,
						(float) output[i + 21] * 25.0f, 1, 1);
				vertex(-30.0f + (float) input[i + 20][0] * 50.0f,
						(float) input[i + 20][1] * 50.0f,
						(float) output[i + 20] * 25.0f, 1, 0);
				endShape();
			}
		}
		...
		for (int i = 0; i < observations; i += 1) {
			...
			pushMatrix();
			translate(-30 + (float) input[i][0] * 50.0f,
					(float) input[i][1] * 50.0f, 0.0f);
			...
			pushMatrix();
			translate(-2 * step + (float) input[i][0] * factor, 0.0f
					+ (float) input[i][1] * factor, 0.0f);
			...
			pushMatrix();
			translate(0 + (float) input[i][0] * factor, 0.0f
					+ (float) input[i][1] * factor, 0.0f);
			...
			pushMatrix();
			translate(-4 * step + (float) input[i][0] * factor, 0.0f
					+ (float) input[i][1] * factor, 0.0f);
	...
	void initData(int tAO) {
		for (int t = 0; t < tAO; t += 1) {
			...
			input[t][2] = 1;
			output[t] = 0.2 * (Math.sin(7.5 * input[t][0]) + Math
					.sin(5.7 * input[t][1]));
