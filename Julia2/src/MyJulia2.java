...
public class MyJulia2 extends Applet {
	...
	public void paint(Graphics g) {
		...
		realpart = realpart - realinc; // this is done once so realpart is at
										// boundary on 1st pass
		...
		for (int x = 0; x < 400; x++) {
			...
			for (int y = 50; y < 450; y++) {
				...
				storerealpart = realpart; // store current location in complex
											// plane
				...
				while (i < 100) {
					btemp = 2 * a * b; // store this product otherwise it would
										// also effect value of a
