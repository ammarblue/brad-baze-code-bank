...
public class CopyOfappGUI extends PApplet {
	...
	public void setup() {
		...
		// BWB032513
		new PropertySliderInteger("Rect size", rSize, 0, 10).add(gui);
		// END_BWB
		// BWB032513
		new PropertyProgBar("Size", rSize, 10,5).add(gui);
		new PropertyProgBar("Time", time2,6,6).add(gui);
		// END_BWB
	...
	class PropertyPBar extends Property {
		...
		private Rect getBox(int xoff) {
			...
			return new Rect((int) fpos - 5, _y + 8,xoff, 10);
		}
